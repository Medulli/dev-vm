...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/medulli"
...
-- Binary clock
local binclock = require("themes.medulli.binclock"){
    height = 16,
    show_seconds = true,
...
theme.cal = lain.widget.calendar({
    cal = "/usr/bin/env TERM=linux /usr/bin/cal -h",
...
--theme.volume = lain.widget.alsabar({
    ...
    --notification_preset = { font = "Terminess Powerline 10", fg = theme.fg_normal },
--})
...
theme.fs = lain.widget.fs({
    ...
    notification_preset = { fg = theme.fg_normal, bg = theme.bg_normal, font = "Terminess Powerline 10" },
    settings = function()
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#FEFEFE", " " .. math.floor(net_now.received+0.5) .. " ↓↑ " .. math.floor(net_now.sent+0.5) .. " "))
    end
})
